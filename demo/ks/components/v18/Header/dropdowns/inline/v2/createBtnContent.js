...
export const createBtnContent = (element) => {
    ...
    btnContent.className = "flex items-center w-full justify-between";

    const leftWrapper = document.createElement("div");
    leftWrapper.className = "flex items-center";
    ...
    span.className = className || "ml-3 text-base";

    leftWrapper.append(iconDiv, span);
    ...
    btnContent.append(leftWrapper, chevronDiv);
